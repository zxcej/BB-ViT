"""
Modified from https://github.com/rayleizhu
"""
import argparse
import datetime
import json
...
def get_args_parser():
    ...
    parser.add_argument('--data-path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='Kvasir', choices=['CIFAR', 'IMNET', 'INAT', 'INAT19', 'Kvasir'],
...
def main(args):
    ...
    if args.finetune:
        if args.finetune.startswith('https'):
            ...
            # hack to load checkpoint from windows to linux/macOS
